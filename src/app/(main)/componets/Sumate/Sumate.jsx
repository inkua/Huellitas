...
function Sumate() {
    return (
        <div className="flex justify-center bg-primaryColor relative">
            <div className="container w-full lg:w-4/5 p-4 lg:p-2 font-[Poppins] max-w-screen-2xl mx-auto">
            <div className="flex-1 absolute invisible md:visible md:absolute  bottom-0 end-0 md:w-6/12 lg:w-5/12">
                <Image src={'/assets/Sumate/girlDogDesktop.png'} width={500} height={100} style={{ width: '100%', height: '100%' }} quality={100} alt="ImageMobile" />
            </div>
            <div className="flex-1 absolute bottom-0 end-0 w-6/12 sm:w-5/12 md:hidden">
                <Image src={'/assets/Sumate/girlDogMobile.png'} width={500} height={100} style={{ width: '100%', height: '100%' }} quality={100} alt="ImageMobile" />
            </div>
