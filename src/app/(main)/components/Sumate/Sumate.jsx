    ...
    return (
        <div className="flex justify-center bg-primaryColor relative">
            <div className="flex-1 hide  bottom-0 end-0 md:absolute md:w-5/12 ">
                <Image src={'/assets/Sumate/girlDogDesktop.png'} width={180} height={180} style={{ width: '100%', height: 'auto' }} alt="ImageDesktop" />
            </div>
            <div className="flex items-center w-full  relative ">
                <div className="flex-1 absolute bottom-0 end-0 w-6/12 md:hidden">
                    <Image src={'/assets/Sumate/girlDogMobile.png'} width={200} height={200} style={{ width: '100%', height: '100%' }} alt="ImageMobile" />
                </div>
