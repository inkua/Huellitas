...
function NewsletterForm() {
  ...
  return (
    <form onSubmit={handleFormSubmit} className="bg-[#f9f9f9] rounded-2xl w-80 h-[175px] flex flex-col justify-center items-center gap-4 px-6">
      <p className="text-primaryFont font-medium">
      ...
      <input
        ...
        className="w-full p-1 px-4 border border-gray-400 rounded placeholder-gray-400 text-primaryFont focus:border-primaryColor focus:outline-none "
      />
      <button
        type="submit" // Cambia el tipo del botón a "submit"
        className="w-full h-8 bg-primaryColor rounded font-semibold text-sm shadow-gray-400 shadow-md"
      >
        SUSCRÍBETE
      </button>
    </form>
