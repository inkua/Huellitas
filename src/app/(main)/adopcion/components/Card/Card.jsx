                  ...
                  >
                     ...
                     <div className="flex h-full flex-col justify-between gap-4" role="list">
                        ...
                        <p className="!font-bold par-1">
                           Caracteristicas: <span className="par-1">{characteristics}</span>
                        </p>
                        <p className="!font-bold par-1">
                           Historia: <span className="par-1">{story}</span>
                        </p>
                        <div className="flex gap-2 relative items-center">
                           ...
                           <Link
                              href={
                                 "https://docs.google.com/forms/d/e/1FAIpQLSfb-E2A6MtG0pbYgTzPyPjR_DnZxS26YR-DMcvt9gTHOI_XCA/viewform"
                              }
                              target="_blank"
                           >
                              <button type="button" className="primary-btn">
