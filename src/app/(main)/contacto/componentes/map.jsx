    ...
    return(
        <div className='w-full bg-tertiaryColor h-fit'>
            <div className="w-full ml-[10%]  h-full max-w-screen-2xl mx-auto  grid grid-cols-1 gap-6 content-start  lg:grid-cols-2 lg:gap-0">          
                <div className='w-full  max-w-screen-2xl ml-[10%]'>
                    <div className='grid grid-cols-1'>
                        ...
                        <iframe className='lg:w-[70%] w-fit h-[300px] lg:h-[400px] ' width="400" height="400" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Cartagena,%20Colombia+(Huellitas)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
