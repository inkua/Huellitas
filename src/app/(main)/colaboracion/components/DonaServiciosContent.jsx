const DonaServiciosContent = ({onClose}) => {
  return (
    <div className="w-[90%] md:w-[80%] lg:w-[50%] max-h-[95%] bg-white rounded-3xl p-8 relative flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col justify-center items-center bg-primaryColor rounded-lg p-16 py-8 gap-4">
