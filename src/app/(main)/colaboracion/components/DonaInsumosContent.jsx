const DonaInsumosContent = ({ onClose }) => {
  return (
    <div className="w-[90%] md:w-[80%] lg:w-[60%] max-h-[95%] bg-white rounded-3xl p-6 md:p-12 lg:p-14 relative flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col gap-4 bg-primaryColor rounded-3xl mt-4 py-4 px-4 lg:px-20 w-full">
        ...
        <p className="par-3 !text-white">*En caso de ser cosas grandes, como ser casillas, carretillas, etc, coordinar por mail axxxxx@xxxxx.com</p>
