        ...
        <div>
            <div className="flex flex-col items-center  max-w-[700px] ">
                <div className="text-center lg:w-full ">
                    ...
                    <p className="par-3 p3-m primaryFont indent-4 justify-center text-center">
                        Elegí el monto que puedas donar y haz una transfrencia a
                ...
                <div className="flex flex-col items-center space-y-4 py-4 w-full">
                    <div className="flex items-center py-4 gap-4 flex-row lg:gap-24 mr-4">
                        <div className="w-[30%] lg:w-[48%]">
                            <Image
                                src="/assets/Colaboracion/PayPalLogo.svg"
                                alt="PayPalLogo"
                                width={150}
                                height={150}
                            />
                    ...
                    <div className="flex items-center py-4 gap-4 flex-row lg:gap-24 lg:mr-[10rem]  ">
                        <div className="w-[30%] lg:w-full">
                            <Image
                                src="/assets/Colaboracion/daviplata-logo.png"
                                alt="daviplataLogo"
                                width={150}
                                height={150}
                            />
                    ...
                    <div className="flex items-center py-4 gap-4 flex-row lg:gap-24 lg:mr-[10rem] ">
                        <div className="w-[30%] lg:w-full">
                            <Image
                                src="/assets/Colaboracion/nequi-logo.png"
                                alt="nequiLogo"
                                width={150}
                                height={150}
                            />
                    ...
                    <div className="flex items-center py-4 gap-4 flex-row lg:gap-24 lg:ml-[12rem] w-full">
                        <div className="w-[43%] lg:w-[24%]">
                            <Image
                                src="/assets/Colaboracion/bancolombia_logo.png"
                                alt="bancolombiaLogo"
                                width={150}
                                height={150}
                            />
                        ...
                        <div className="flex gap-4 w-[94%] lg:w-full">
                            ...
                            <p className="par-3 line-clamp-1 w-[60%] lg:w-full">
                                {" "}
                                CA 08500009646
                            </p>
                            <button className="lg:hidden">
                ...
                <div className="lg:w-[75%]">
                    <p className="par-3 primaryFont indent-4 text-center mb-10 ">
                        Envianos tu comprobante a{" "}
                        <strong>@huellitascartagena </strong>para llevar cuentas
                        organizadas
                    </p>
                </div>
            ...
            <div className="text-center lg:w-[70%] mt-10 lg:ml-[6.5rem]">
                ...
                <p className="par-3 p3-m primaryFont indent-4 justify-center mb-5">
                    Si querés donar todos los meses, haz click en el siguiente
                    enlace:
                </p>
                <button
                    type="button"
                    className="text-p3-m lg:text-p3-w md:text-p3-w px-4 py-4 lg:py-1 md:py-1 font-medium text-white bg-primaryColor hover:bg-secondaryColor rounded-full shadow-md transition-all duration-150 active:bg-activeButton "
                >
                    QUIERO SER PADRION
                </button>
            </div>
