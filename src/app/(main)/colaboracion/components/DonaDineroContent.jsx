    ...
    (
      <div>
          <div className="flex flex-col items-start  max-w-[800px]">
            ...
            <div className="flex flex-col items-start space-y-4 py-4 w-full border-b border-black">
              <div className="flex items-center py-4 gap-4 flex-row lg:gap-24 mr-12 lg:ml-[10rem] ">
                <div className="w-[15%] lg:w-[48%] ">
                  <Image src="/assets/Colaboracion/PayPalLogo.svg" alt="PayPalLogo" width={150} height={150} />
                </div>
                <div className="flex gap-4 w-[15%] lg:w-full">
                  ...
                  <p className="par-3 flex flex-shrink">huellitasctgna@outlook.com</p>
                  <button className="lg:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">  <path fill="black" d="M21 8.94a1.31 1.31 0 0 0-.06-.27v-.09a1.07 1.07 0 0 0-.19-.28l-6-6a1.07 1.07 0 0 0-.28-.19a.32.32 0 0 0-.09 0a.88.88 0 0 0-.33-.11H10a3 3 0 0 0-3 3v1H6a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3v-1h1a3 3 0 0 0 3-3V9zm-6-3.53L17.59 8H16a1 1 0 0 1-1-1ZM15 19a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1h1v7a3 3 0 0 0 3 3h5Zm4-4a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h3v3a3 3 0 0 0 3 3h3Z"></path></svg>
                  </button>  
                </div>
              </div>
              <div className="flex items-center py-4 gap-4 flex-row lg:gap-24 lg:mr-[10rem]  lg:ml-[10rem] ">
              ...
              <div className="flex items-center py-4 gap-4 flex-row lg:gap-24  w-full lg:ml-[10rem] ">
                ...
                <div className="flex gap-4 w-[94%] lg:w-full">
                  ...
                  <p className="par-3 line-clamp-1 w-[50%] lg:w-full"> CA 08500009646</p>
                  <button className="lg:hidden">
                    <svg  xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">  <path fill="black" d="M21 8.94a1.31 1.31 0 0 0-.06-.27v-.09a1.07 1.07 0 0 0-.19-.28l-6-6a1.07 1.07 0 0 0-.28-.19a.32.32 0 0 0-.09 0a.88.88 0 0 0-.33-.11H10a3 3 0 0 0-3 3v1H6a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3v-1h1a3 3 0 0 0 3-3V9zm-6-3.53L17.59 8H16a1 1 0 0 1-1-1ZM15 19a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1h1v7a3 3 0 0 0 3 3h5Zm4-4a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h3v3a3 3 0 0 0 3 3h3Z"></path></svg>
                  </button>  
                </div>
            ...
            <div className="lg:w-[75%]">            
              <p className="par-3 primaryFont indent-4 text-center mb-10 lg:ml-[10rem]  ">Envianos tu comprobante a <strong>@huellitascartagena </strong>para llevar cuentas organizadas</p>
            </div>
