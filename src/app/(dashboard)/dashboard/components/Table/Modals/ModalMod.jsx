            ...
            <div className="relative p-4 w-full max-w-md max-h-full">
               <div className="relative bg-[#f2f0fd] rounded-lg shadow ">
                  <div className="flex items-center rounded-t-xl border-2 border-primaryColor justify-between p-4 md:p-5">
                     <h3 className="text-lg font-semibold text-[#6b6b6b]">Modificar</h3>
                     <button
                           ...
                           <>
                              <div className="col-span-2">
                                 ...
                                 <textarea
                                    ...
                                    defaultValue={item.data.caracteristicas}
                                    required
                                 ></textarea>
                              </div>
                              <div className="col-span-2">
                              ...
                              <div className="col-span-2">
                                 ...
                                 <textarea
                                    ...
                                    defaultValue={item.data.historia}
                                    required
                                 ></textarea>
                              </div>
                           </>
