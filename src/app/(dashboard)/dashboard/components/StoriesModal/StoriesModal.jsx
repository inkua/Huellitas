         ...
         <div className="relative p-4 w-full  md:w-[70vw] md:max-w-[900px] max-h-full">
            <div className="relative bg-[#f2f0fd] rounded-xl shadow ">
               <div className="flex items-center rounded-t-xl border-2 border-primaryColor justify-between p-4 md:p-5">
                  <h3 className="text-lg font-semibold text-[#6b6b6b]">{add ? "Añadir Nueva" : "Modificar"}</h3>
                  <button
                     onClick={() => handleclose()}
                     type="button"
               ...
               {loading ? (
                  ...
                  >
                     <div className="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div className="col-span-2">
                           <label htmlFor="entradilla" className="block mb-2 text-sm font-medium text-[#6b6b6b]">
                              Entradilla{" "}
                        ...
                        <div className="col-span-2">
                           <label htmlFor="articulo" className="block mb-2 text-sm font-medium text-[#6b6b6b]">
                              Artículo
                           </label>
