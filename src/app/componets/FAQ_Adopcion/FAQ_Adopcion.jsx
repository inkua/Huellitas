    ...
    return (
        <div class="container w-full md:w-4/5 mx-auto p-4 md:p-2">
            ...
            <div class="text-left mb-4">
                <h2 class="text-lg text-blackHtas">Adopción</h2>
            ...
            <div class="flex flex-col md:flex-row items-start"> 
                <div class="mb-4 md:mb-0 md:mr-4 w-full md:w-1/2 md:hidden">
                    <Image src={Woman_sign_mobile} class="rounded-lg w-full" alt="Peting dog desktop" />
                </div>
                
                <Image src={Woman_sign_desktop} class="rounded-xl md:mb-4 md:ml-4 md:w-4/12 hidden md:block md:mr-7" alt="Peting dog desktop" />
