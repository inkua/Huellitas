        ...
        <div className="container w-full lg:w-4/5 mx-auto p-4 lg:p-2 font-[Poppins]">
            ...
            <div className="flex flex-col lg:flex-row items-start"> 
                <div className="mb-4 lg:mb-0 lg:mr-4 w-full lg:w-1/2 lg:hidden">
                    <Image src={Woman_sign_mobile} width={700} height={100} quality={100}  className="rounded-lg w-full" alt="Sing dog Mobile" />
                </div>
                
                <Image src={Woman_sign_desktop}  width={700} height={100} quality={100}  className="rounded-xl lg:mb-4 lg:ml-4 lg:w-4/12 hidden lg:block lg:mr-7" alt="Sing dog desktop" />
