    ...
    return (
        <div className="container w-full md:w-4/5 mx-auto p-4 md:p-2">
            ...
            <div className="text-left mb-4">
                <h2 className="text-lg text-blackHtas">Colaboración</h2>
            ...
            <div className="flex flex-col md:flex-row items-start"> 
                ...
                <Image src={Peting_dog_desktop} className="rounded-xl md:mb-4  md:w-4/12 hidden md:block md:ml-7 object-cover" alt="woman sign" />
