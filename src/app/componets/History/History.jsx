    ...
    return (
        <section>
            <div className='flex flex-col w-full max-w-screen-2xl mx-auto justify-center items-center gap-8 py-16 bg-white'>
                <h1 className='w-11/12 lg:w-9/12 font-bold text-center lg:text-left md:text-left text-3xl text-black'>SIGUE SUS HISTORIAS</h1>
                <div className='grid grid-cols-[90%_90%_90%] lg:grid-cols-3 w-full lg:w-9/12 px-4 overflow-x-scroll snap-mandatory snap-x no-scrollbar gap-4'>
